...
Rom.nvram = {
	...
	init: function() {
		 ...
		 */
		 ...
		 Register.user_id = PCB.nvramController.cookie_read('userID_FR','');
	},
	/**
	...
	/**
	* Updates the current user id. Key is 'userID_FR'
	*
	* @param      string user id to be saved
	*/
	updateUserID: function( _userID ) {
		PCB.nvramController.cookie_write('userID_FR',String(_userID));
	},
	/**
